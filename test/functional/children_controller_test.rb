...
class ChildrenControllerTest < ActionController::TestCase
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post :create, child: { age: @child.age, child_care: @child.child_care, language: @child.language, name: @child.name }
    end
  ...
  test "should update child" do
    put :update, id: @child, child: { age: @child.age, child_care: @child.child_care, language: @child.language, name: @child.name }
    assert_redirected_to child_path(assigns(:child))
  end
